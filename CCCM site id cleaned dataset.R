...
response <- read.xlsx("./data/cleaning/Master tbc/Master/CCCM_Site_Reporting (V2)_Master_tbc.xlsx")
...
cleaning_log <- read.xlsx("./data/CCCM_SiteID_Cleaning log (V2)_Master_Script_V2.xlsx", sheet = "cleaning_log")
